    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontFamily: "Cormorant Garamond, serif", fontStyle: "italic", fontSize: "17px", color: "rgba(240,224,200,0.75)", lineHeight: 1.8, marginBottom: "28px" }}>
          A CS student needs a personal AI that listens to lectures, summarises key points, answers questions by voice, and generates flashcards automatically.
        </p>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "28px" }}>
          {[["Budget", "🌱 Startup"], ["Timeline", "⏳ 2 weeks"], ["Users", "👤 Solo dev"]].map(([label, value]) => (
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "32px" }}>
          {["🎙 Voice Input", "🧠 LLM Reasoning", "📝 Summarisation", "🔊 Voice Output", "📚 Flashcards"].map(cap => (
