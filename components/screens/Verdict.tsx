...
export default function Verdict({ goTo }: Props) {
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ maxWidth: "700px", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", gap: "28px" }}>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <button onClick={() => goTo("brief")} style={{ padding: "13px 32px", background: "linear-gradient(135deg, #0d2e1a, #1a9e8f, #0d2e1a)", border: "1px solid rgba(26,158,143,0.4)", color: "#f0e0c8", fontFamily: "Special Elite, cursive", fontSize: "13px", letterSpacing: "2px", cursor: "pointer", borderRadius: "2px" }}>
            🔄 Try Another Brief
          </button>
